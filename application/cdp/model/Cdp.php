...
//				$vo['task_count'] = CdpTask::getCount($vo['device_id'],'id');
//				$vo['virtual_count'] = ComputeVirtual::getCount($vo['device_id'],'id');
//				$vo['virtual_on_count'] = ComputeVirtual::getVirtualOnCount($vo['device_id'],'id');
				if($deviceInfo){
	...
	public function getDevice()
	{
		...
		$sql = "select $field_str ,Count($alias.id) AS task_count from "
				...
				"LEFT JOIN $prefix"."cdp_task as task ON $alias.id=task.device_id And task.type!='current' ".
				"WHERE cdp.status=1 ".
				"GROUP BY $alias.id";
