...
class Api extends Admin{
    ...
    public function create(){
        ...
        $device_field = array('id','ip','alias');
        ...
        $snap_info = $this->get_snap($newest_task_id,$type);
        if(!$snap_info){
            return $this->getError();
        }
        ...
        $config['is_sata'] = strpos($system_info['systemversion'],"2012 Datacenter")?1:0;
        $config['task_id'] = $newest_task_id;
    ...
    private function get_snap($task_id,$type){
