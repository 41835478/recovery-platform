...
return [
	...
	'base_url'          => BASE_PATH,
	// traits 目录
    'traits_path'      => APP_PATH . 'common' . DS ,
	...
	'system_package' => [
		...
		'subName'  => ['date', 'Ymd'],
		//保存根路径
		'rootPath' => './uploads/cloud/package',
		// 保存路径
		'savePath' => '',
		// 上传文件命名规则，[0]-函数名，[1]-参数，多个参数使用数组
		'saveName' => ['uniqid', ''],
