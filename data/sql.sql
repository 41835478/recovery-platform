...
INSERT INTO `qinfo_auth_rule` VALUES ('119', 'cdp', '2', 'cdp/index/index', 'cdp_manage', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('120', 'cdp', '2', 'cdp/index/add_device', 'addcdp_device', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('121', 'cdp', '2', 'cdp/index/del_device', 'delcdp_device', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('122', 'cdp', '2', 'cdp/index/detail', 'detail_cdp', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('123', 'cdp', '2', 'cdp/index/task_add', 'addcdp_task', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('124', 'cdp', '2', 'cdp/index/get_task_snap', 'getcdp_task_snap', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('125', 'cdp', '2', 'cdp/index/get_clone_state', 'getcdp_clone_state', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('126', 'cdp', '2', 'cdp/index/task_status', 'cdp_task_status', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('127', 'cdp', '2', 'cdp/index/create_snap', 'cdp_create_snap', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('128', 'cdp', '2', 'cdp/index/merge_snap', 'cdp_merge_snap', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('129', 'cdp', '2', 'cdp/index/del_task', 'cdp_del_task', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('130', 'cdp', '2', 'cdp/index/snap_detail', 'cdp_snap_detail', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('131', 'cdp', '2', 'cdp/index/auto_conf', 'cdp_auto_conf', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('132', 'cdp', '2', 'cdp/index/edit_auto_config', 'edit_auto_config', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('133', 'cdp', '2', 'cdp/index/add_auto_config', 'add_auto_config', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('134', 'cdp', '2', 'cdp/index/add_virtual', 'add_cdp_virtual', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('135', 'cdp', '2', 'device/manage/generate_mac_addr', 'generate_mac_addr', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('136', 'cdp', '2', 'cdp/index/add_keli', 'add_cdp_keli', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('137', 'cdp', '2', 'cdp/index/get_task', 'get_cdp_task', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('138', 'cdp', '2', 'cdp/index/task_edit', 'edit_cdp_task', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('139', 'cdp', '2', 'cdp/index/snap_del', 'delete_cdp_snap', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('140', 'cdp', '2', 'cdp/index/get_log', 'get_log', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('141', 'admin', '2', 'admin/license/index', 'license', 'home', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('142', 'admin', '2', 'admin/license/license', 'auth_activation', 'home', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('143', 'device', '2', 'device/manage/compute_del', 'del_compute', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('144', 'device', '2', 'device/manage/update_compute', 'update_compute', 'device', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('145', 'admin', '2', 'admin/action/detail', 'action_detail', 'user', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('146', 'admin', '2', 'admin/upload/upload', 'file_upload', 'home', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('147', 'admin', '2', 'admin/upload/delete', 'file_upload_del', 'home', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('148', 'admin', '2', 'admin/module/import_module', 'import_module', 'system', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('149', 'admin', '2', 'admin/cloud/getversionlist', 'cloud_getversion', 'system', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('150', 'admin', '2', 'admin/cloud/updategoods', 'cloud_updategoods', 'system', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('151', 'admin', '2', 'admin/cloud/updating1', 'cloud_updating1', 'system', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('152', 'admin', '2', 'admin/cloud/updating2', 'cloud_updating2', 'system', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('153', 'admin', '2', 'admin/cloud/updating3', 'cloud_updating3', 'system', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('154', 'admin', '2', 'admin/cloud/updating4', 'cloud_updating4', 'system', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('155', 'admin', '2', 'admin/cloud/updating5', 'cloud_updating5', 'system', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('156', 'admin', '2', 'admin/module/del', 'del_module', 'system', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('157', 'admin', '2', 'admin/module/manual_upgrade', 'manual_upgrade', 'system', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('158', 'admin', '2', 'admin/user/updata_avatar', 'updata_avatar', 'user', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('159', 'admin', '2', 'admin/user/auth_device', 'auth_device', 'user', '1', '');
INSERT INTO `qinfo_auth_rule` VALUES ('160', 'admin', '2', 'admin/log/index', 'log_report', 'home', '1', '');
-- -----------------------------
...
INSERT INTO `qinfo_menu` VALUES ('23', 'plugin_list', 'usb', '2', '8', 'admin/addons/index', '0', '', 'local', '0', '0', 'admin');
...
INSERT INTO `qinfo_menu` VALUES ('44', 'cloud_market', '', '2', '5', 'admin/cloud/index', '0', '', 'cloud_market', '0', '0', 'admin');
INSERT INTO `qinfo_menu` VALUES ('45', 'auto_update', '', '2', '6', 'admin/cloud/update', '0', '', 'cloud_market', '0', '0', 'admin');
