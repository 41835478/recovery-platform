...
(function () {
    ...
    RFB = function (defaults) {
        ...
        Util.set_defaults(this, defaults, {
			...
			'onUpdateVncname': function () { },       // onUpdateVncname(_fb_name): state update/change
        ...
        this._sock.on('open', function () {
            if (this._rfb_state === 'connect') {
                this._updateState('ProtocolVersion', "VNC 启动中，请等待...");
            } else {
                this._fail("WebSocket连接失败");
            }
        }.bind(this));
        this._sock.on('close', function (e) {
            Util.Warn("WebSocket误错的请求");
            var msg = "";
            if (e.code) {
                msg = " (code: " + e.code;
                if (e.reason) {
            ...
            if (this._rfb_state === 'disconnect') {
                this._updateState('disconnected', 'VNC连接' + msg);
            } else if (this._rfb_state === 'ProtocolVersion') {
                this._fail('无法连接到服务器' + msg);
            } else if (this._rfb_state in {'failed': 1, 'disconnected': 1}) {
                Util.Error("Received onclose while disconnected" + msg);
            } else {
                this._fail("服务器连接断开" + msg);
            }
            this._sock.off('close');
        }.bind(this));
        this._sock.on('error', function (e) {
            Util.Warn("WebSocket 误错的请求");
        });
    ...
    RFB.prototype = {
        ...
        _negotiate_protocol_version: function () {
            ...
            switch (sversion) {
                ...
                case "004.001":  // RealVNC 4.6
                    ...
                    break;
                default:
                    return this._fail("无效的服务版本" + sversion);
            }
            ...
            this._updateState('Security', '版本: ' + cversion);//显示系统版本号SDW
        },
        ...
        _negotiate_security: function () {
            if (this._rfb_version >= 3.7) {
                ...
                if (this._rfb_auth_scheme === 0) {
                    return this._fail("不支持的安全类型: " + types);
                }
            ...
            this._updateState('Authentication', '认证方案: ' + this._rfb_auth_scheme);
        ...
        _negotiate_std_vnc_auth: function () {
            if (this._rfb_password.length === 0) {
                ...
                this._updateState('password', "需要密码");
                this._onPasswordRequired(this);
                return false;
            }
        ...
        _negotiate_tight_tunnels: function (numTunnels) {
            ...
            if (serverSupportedTunnelTypes[0]) {
                if (serverSupportedTunnelTypes[0].vendor != clientSupportedTunnelTypes[0].vendor ||
                    ...
                    return this._fail("客户的隧道类型有不正确的供应商或签名");
                }
                this._sock.send([0, 0, 0, 0]);  // use NOTUNNEL
                return false; // wait until we receive the sub auth count to continue
            } else {
                return this._fail("服务器需要的隧道，但不支持notunnel型");
            }
        },
            ...
            for (var authType in clientSupportedTypes) {
                if (serverSupportedTypes.indexOf(authType) != -1) {
                    ...
                    switch (authType) {
                        ...
                        default:
                            return this._fail("不支持小的认证方案: " + authType);
                    }
                }
            }
        ...
        _negotiate_authentication: function () {
            switch (this._rfb_auth_scheme) {
                ...
                case 1:  // no auth
                    ...
                    this._updateState('ClientInitialisation', "无认证要求");
                    return this._init_msg();
                ...
                default:
                    return this._fail("不支持的认证方案: " + this._rfb_auth_scheme);
            }
        },
        ...
        _handle_security_result: function () {
            ...
            switch (this._sock.rQshift32()) {
                case 0:  // OK
                    this._updateState('ClientInitialisation', '认证通过');
                    return this._init_msg();
                case 1:  // failed
                    if (this._rfb_version >= 3.8) {
                        ...
                        return this._fail("身份验证失败");
                    }
                    return false;
                case 2:
                    return this._fail("太多的权威性的尝试");
            }
        },
        ...
        _negotiate_server_init: function () {
			...
			//this._onUpdateVncname(this._fb_name);
            ...
            if (this._encrypt) {
                this._updateState('normal', '链接VNC(加密): ' + this._fb_name);
            } else {
                this._updateState('normal', '链接VNC(非加密): ' + this._fb_name);
            }
        },
        ...
        _init_msg: function () {
            switch (this._rfb_state) {
                ...
                case 'ClientInitialisation':
                    ...
                    this._updateState('ServerInitialisation', "认证通过");
                    return true;
        ...
        _handle_xvp_msg: function () {
            ...
            switch (xvp_msg) {
                case 0:  // XVP_FAIL
                    this._updateState(this._rfb_state, "操作失败");
                    break;
                case 1:  // XVP_INIT
                    ...
                    break;
                default:
                    this._fail("断开：非法XVP服务消息 " + xvp_msg);
                    break;
            }
        ...
        _normal_msg: function () {
            ...
            switch (msg_type) {
                ...
                default:
                    this._fail("断开：非法的服务器消息类型 " + msg_type);
    ...
    Util.make_properties(RFB, [
		...
		['onUpdateVncname', 'rw', 'func'],        // onUpdateVncname(_fb_name): RFB state update/change
        ...
        HEXTILE: function () {
            ...
            while (this._FBU.tiles > 0) {
                ...
                if (subencoding > 30) {  // Raw
                    this._fail("断开：非法Hextile subencoding " + subencoding);
                    return false;
                }
