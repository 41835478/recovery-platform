<?php
 ...
 class W2I_Configure_Vmx_Ex extends \DrSlump\Protobuf\Message
 {
   // @@protoc_insertion_point(traits:.net_message.W2S_Reset_Client_SystemId)
	...
	public $nCoreNum;
	public $nMemorySize;
	public $nNetCardModifyMode;
	public $nNetCardPhysicalType;
	public $nMacSetType;
	public $nConnectionType;
	public $nDiskType;
	public $sVmxPath;
	public $sAddVmdkPath;
	public $sDeleteVmdkPath;
	public $sMac;
	public $sUrl;
	public $sNetInfo;
 
   protected static $__extensions = array();  // @@protoc_insertion_point(properties_scope:.net_message.W2S_Reset_Client_SystemId)
   ...
   public static function descriptor()
   {
		...
		$f->rule      = \DrSlump\Protobuf::RULE_OPTIONAL;
		$descriptor->addField($f);
		// @@protoc_insertion_point(builder_scope:.net_message.W2S_Reset_Client_SystemId)
