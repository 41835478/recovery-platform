...
// +----------------------------------------------------------------------
// | Author: colin <register@qinfo360.com> <http://www.qinfo360.com>
// +----------------------------------------------------------------------
namespace com;
use think\Db;
...
class Datatable{
	...
	/**
	 * 获取指定表名的所有字段及详细信息
	 * @var $table 要获取名字的表名 可以为qinfo_tengsu_photo、tengsu_photo、photo
	 * @author colin <register@qinfo360.com>
	 */
	...
	/**
	 * 确认表是否存在
	 * @var $table 表名 可以为qinfo_tengsu_photo、tengsu_photo、photo
	 * @author colin <register@qinfo360.com>
	 * @return boolen
	 */
